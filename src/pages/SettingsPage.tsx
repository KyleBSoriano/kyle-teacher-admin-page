...
const SettingsPage = () => {
  const { user, signOut, refreshUserProfile } = useAuthContext();
          ...
          <CardContent className="space-y-4 p-4">
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <HelpTooltip content="Your preferred name as it appears on your account" />
                </div>
                <Input 
                  id="name" 
                  value={name}
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  ...
                  <HelpTooltip content="Your email address for account notifications and login" />
                </div>
                <Input 
                  id="email" 
                  type="email" 
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                <div className="flex items-center">
                  ...
                  <HelpTooltip content="Toggle question mark icons throughout the app that provide helpful explanations" />
                </div>
